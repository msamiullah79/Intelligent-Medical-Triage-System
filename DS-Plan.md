...
|----------------------------------|-------------------|--------------------------------------------|
| Add patient to waiting line       | Max Heap           | Automatically prioritizes patients based on predicted priority |
| Store patient medical history     | Linked List        | Efficiently appends and maintains chronological visit history |
